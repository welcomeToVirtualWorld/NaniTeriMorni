...
public class StoriesAdapterHorizontal extends RecyclerView.Adapter<StoriesAdapterHorizontal.MyViewHolder> implements Filterable {
    private Context context;
    private List<Datum> data;
    private List<Datum> fulldata;
    private StoriesAdapter.ClickListener listener;
    public StoriesAdapterHorizontal(Context context, List<Datum> data, StoriesAdapter.ClickListener listener)
    {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new StoriesAdapterHorizontal.MyViewHolder(view);
    }
